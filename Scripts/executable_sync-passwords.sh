...
# crontab job for this script - (crontab -l; echo "*/45 * * * * $HOME/Scripts/sync-passwords.sh") | crontab -
...
LOCAL_LOCATION="$HOME/Documents/Backups"
REMOTE_LOCATION="Backups/Keepass"
